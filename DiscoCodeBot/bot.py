...
from DiscoCodeBot import events
...
class DiscordBot:
    ...
    def _attach_events(self):
        ...
        @self.client.event
        async def on_ready():
            self.registry.register(await generate_commands(), alt=True)
    ...
    async def emit(self, data):
        ...
        from DiscoCodeClient.consumers import ClientConsumer
    ...
    def import_commands(self, directory="commands"):
        ...
        for file_name in command_files:
            ...
            module = importlib.import_module(module_name, 'DiscoCodeBot.commands')
