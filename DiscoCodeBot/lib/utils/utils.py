from DiscoCodeClient.utils import get_users_in_server, add_user
from DiscoCodeBot.managers.ui_manager import ApproveNewUser
...
async def handle_unregistered(message, ctx):
    ...
    response_message = f"User requires registration before use.\nAdmin approval needed.\n{admin_mentions}"
